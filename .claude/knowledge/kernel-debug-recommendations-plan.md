...
- [ ] D1-followup — Tag remaining global SpinLocks (cleanroom_trace `g_cleanroom_lock`, wifi `g_lock`) with class IDs once their canonical ordering vs the existing tags is settled
