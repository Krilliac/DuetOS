...
_Status: Active — six new clean-room TUs in `kernel/util/` (plus
HMAC-MD5 grafted onto the existing `kernel/crypto/hmac`)._
...
| TGA 2.0 decoder | `kernel/util/tga.{h,cpp}` | Truevision TGA 2.0 | 7 (32-bpp + 24-bpp round-trips, 5 negative cases) | ImageView (active — slice 5 below) |
