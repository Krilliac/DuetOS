...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 1,640 | ◐ partial (8 sibling TUs landed: complete/input/speed/admin/ring/event/descparse + header-hoisted MMIO; structs+globals exposed via xhci_internal.h; init/control/InitOne sub-splits next) |
