...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 2,251 | ◐ partial (CompletionCodeName + HID input + MMIO accessors extracted into xhci_complete.cpp/xhci_input.cpp/xhci_internal.h; per-aspect core/init/xfer/enum sub-splits deferred) |
