...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 2,463 | ◐ partial (CompletionCodeName extracted into xhci_complete.cpp + xhci_internal.h scaffolding; per-aspect core/init/xfer/enum sub-splits deferred) |
