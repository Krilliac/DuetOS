...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 1,332 | ◐ partial (11 sibling TUs landed: complete/input/speed/admin/ring/event/descparse/context/irq/control + header-hoisted MMIO; structs+globals+PollTaskArg+IRQ stamps+control helpers exposed via xhci_internal.h; HidPollEntry/InitOne sub-splits next) |
