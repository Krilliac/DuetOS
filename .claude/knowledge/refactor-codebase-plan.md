...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 2,268 | ◐ partial (CompletionCodeName + HID-input translation extracted into xhci_complete.cpp/xhci_input.cpp + xhci_internal.h scaffolding; per-aspect core/init/xfer/enum sub-splits deferred) |
