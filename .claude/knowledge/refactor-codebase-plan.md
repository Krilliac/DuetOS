...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 1,710 | ◐ partial (7 sibling TUs landed: complete/input/speed/admin/ring/event + header-hoisted MMIO; structs+globals exposed via xhci_internal.h; per-aspect xfer/init/enum sub-splits next) |
