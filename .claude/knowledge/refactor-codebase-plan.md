...
| 5 | `kernel/drivers/usb/xhci.cpp`         | 2,548 | 1,825 | ◐ partial (6 sibling TUs landed: complete/input/speed/admin/ring + header-hoisted MMIO; structs+globals exposed via xhci_internal.h; per-aspect xfer/init/enum sub-splits next) |
