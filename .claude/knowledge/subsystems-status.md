...
- **NtCreateProcess / CreateProcessW** — subprocess spawn (high impact for Windows malware compat; complex because needs section-from-file)
- **LPC / ALPC family** — IPC backbone (NtCreatePort / NtConnectPort / NtRequestPort / NtReplyPort)
- **NtNotifyChangeDirectoryFile** — could be wired to inotify
- **NtJobObject family** — job objects, resource limits
- **IOCP**: NtSetIoCompletion / NtRemoveIoCompletion / NtRemoveIoCompletionEx
...
- **NtNotifyChangeDirectoryFile**: wire to inotify
