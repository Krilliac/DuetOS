...
| Kernel & debug design recommendations — 18-item leverage-ordered plan | [knowledge/kernel-debug-recommendations-plan.md](knowledge/kernel-debug-recommendations-plan.md) | Plan | Active (A1 + A4 + C2 + B1 partial + A3 + A2 infra landed; structural items complete; B2/D1/E1 next) | 2026-04-27 |
