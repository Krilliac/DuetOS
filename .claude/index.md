...
| End-user feature gaps v0 — prioritized inventory of what an ordinary user notices is missing (audio / Wi-Fi / save-to-disk / Settings panel / accessibility) | [knowledge/feature-gaps-end-user-v0.md](knowledge/feature-gaps-end-user-v0.md) | Observation + Decision | Active — 14 of 27 fully landed (P1 #7 BMP image viewer 2026-05-02 + Files FAT32 disk view 2026-05-02 + Files .TXT dispatch + delete + Settings SHUTDOWN/REBOOT 2026-05-02) + P0 #4 Wi-Fi data-decode + full control tier; remainder either blocked on driver/FS infra or deferred refactors | 2026-05-02 |
