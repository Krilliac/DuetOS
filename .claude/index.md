...
| qemu-smoke #DE flake at PicDisable — saved RIP post-out, vector 0 reported, only on GitHub-hosted TCG runners; smoke retry catches it | [knowledge/qemu-smoke-pic-de-flake-v0.md](knowledge/qemu-smoke-pic-de-flake-v0.md) | Observation | Latent — not currently CI-blocking | 2026-04-30 |
