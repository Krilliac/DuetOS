...
| Kernel pure-compute utility libraries v0 — 17 clean-room TUs across two same-day batches. Morning batch (6): HMAC-MD5, Unicode UTF-8/UTF-16, TGA 2.0 decoder, Gregorian↔Julian-Day + ISO 8601 datetime, BMP encoder+parser util (collapsed screenshot+imageview duplicates), CPIO newc walker. Afternoon batch (11): KPTI close-out (loud-WARN), ChaCha20+Poly1305+AEAD (RFC 8439), AES-GCM 128/256 (NIST SP 800-38D), POSIX TZ string parser, WAV/RIFF, TAR ustar, LZ4 raw-block, GTF, DPMS state machine, PSF1/PSF2, TGA encoder. Every TU is allocation-free, KAT-gated at boot, with rejected-but-not-implemented spec features surfaced cleanly | [knowledge/kernel-util-libraries-v0.md](knowledge/kernel-util-libraries-v0.md) | Observation + Decision | Active | 2026-05-03 |
