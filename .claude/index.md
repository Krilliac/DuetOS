...
| Kernel & debug design recommendations — 18-item leverage-ordered plan | [knowledge/kernel-debug-recommendations-plan.md](knowledge/kernel-debug-recommendations-plan.md) | Plan | Active (A1 infra + A4 + C2 + B1 partial landed; SeqLock + RCU + SMP contention tests deferred) | 2026-04-27 |
