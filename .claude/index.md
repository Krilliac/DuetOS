...
| Stub & gap inventory v0 — ~1 050 stubbed/unimplemented/mismapped surfaces (NT 264, Linux 233, thunks, ucrtbase, drivers, FS) + fill-in order + landed table | [knowledge/stub-gap-inventory-v0.md](knowledge/stub-gap-inventory-v0.md) | Observation + Decision | Active | 2026-04-26 |
