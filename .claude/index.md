...
| End-user feature gaps v0 — prioritized inventory of what an ordinary user notices is missing (audio / Wi-Fi / save-to-disk / Settings panel / accessibility) | [knowledge/feature-gaps-end-user-v0.md](knowledge/feature-gaps-end-user-v0.md) | Observation + Decision | Active — 17+ of 27 fully landed (BMP viewer + Files FAT32 view + .TXT dispatch + delete + Settings SHUTDOWN/REBOOT + About/SysInfo + help-text refresh + Help window + Calculator polish + git hash in About + Trash bin + Files defaults to disk view + **Browser (HTTP only) + TCP-buffer lift 2 KiB→64 KiB**, all 2026-05-02) + P0 #4 Wi-Fi data-decode + full control tier; remainder either blocked on driver/FS infra or deferred refactors | 2026-05-02 |
