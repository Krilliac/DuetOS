...
| Smoke PE suite v19 — pass-rate lift to **89.5%**: shell/uxtheme/select/winsock-ext/token/vol/proc2/winerr/enviro/accel impls covering 469 PASS Win32 APIs (118 apps) | [knowledge/smoke-pe-suite-v19.md](knowledge/smoke-pe-suite-v19.md) | Observation + Pattern + Issue | Active | 2026-04-30 |
