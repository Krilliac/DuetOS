...
| Kernel pure-compute utility libraries v0 — 24 clean-room TUs across three same-day batches. Morning (6): HMAC-MD5, Unicode UTF-8/UTF-16, TGA decoder, datetime, BMP util, CPIO walker. Afternoon (11): KPTI close-out, ChaCha20+Poly1305+AEAD, AES-GCM, POSIX TZ, WAV, TAR, LZ4, GTF, DPMS, PSF, TGA encoder. Evening (7): Adler-32, SHA-384/SHA-512, AES-CCM, DEFLATE inflater, GZIP+zlib wrappers, TZif binary timezone parser. Every TU is allocation-free, KAT-gated at boot, with rejected-but-not-implemented spec features surfaced cleanly | [knowledge/kernel-util-libraries-v0.md](knowledge/kernel-util-libraries-v0.md) | Observation + Decision | Active | 2026-05-03 |
