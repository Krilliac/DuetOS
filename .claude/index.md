...
| End-user feature gaps v0 — prioritized inventory of what an ordinary user notices is missing (audio / Wi-Fi / save-to-disk / Settings panel / accessibility) | [knowledge/feature-gaps-end-user-v0.md](knowledge/feature-gaps-end-user-v0.md) | Observation + Decision | Active — 12 of 27 landed (Settings, Notify, LockScreen, Clipboard, Accounts, TZ, Magnifier, Notes save/load, Screenshot, persistent klog, session restore + this entry); remainder either blocked on driver/FS infra or deferred refactors | 2026-05-01 |
