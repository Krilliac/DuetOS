...
| Kernel pure-compute utility libraries v0 — six clean-room TUs landed in one batch: HMAC-MD5 (RFC 2104+1321), Unicode UTF-8/UTF-16 (RFC 3629+Unicode 15), TGA 2.0 decoder, Gregorian↔Julian-Day + ISO 8601 datetime, BMP encoder+parser util (collapsed screenshot+imageview duplicates), CPIO newc walker. Every TU is allocation-free, KAT-gated at boot, with rejected-but-not-implemented spec features surfaced cleanly | [knowledge/kernel-util-libraries-v0.md](knowledge/kernel-util-libraries-v0.md) | Observation + Decision | Active | 2026-05-03 |
