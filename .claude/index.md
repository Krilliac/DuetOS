...
| Smoke PE suite v8 — expanded to 68 apps (+token/security/perf/accel/wts/winerr/sleep/nt) + console-cursor + jobobj + filemapping impls covering 284 PASS Win32 APIs | [knowledge/smoke-pe-suite-v8.md](knowledge/smoke-pe-suite-v8.md) | Observation + Pattern + Issue | Active | 2026-04-30 |
