...
| End-user feature gaps v0 — prioritized inventory of what an ordinary user notices is missing (audio / Wi-Fi / save-to-disk / Settings panel / accessibility) | [knowledge/feature-gaps-end-user-v0.md](knowledge/feature-gaps-end-user-v0.md) | Observation + Decision | Active — 14 of 27 fully landed (P1 #7 BMP image viewer landed 2026-05-02) + P0 #4 Wi-Fi data-decode + full control tier; remainder either blocked on driver/FS infra or deferred refactors | 2026-05-02 |
| Image Viewer v0 — BMP-only kernel app pairs with Screenshot, reads 32-bpp top-down + bottom-up DIBs, streaming NN-downsample via Fat32ReadFileStream, aspect-fit no-upscale, 5-case header round-trip self-test | [knowledge/imageview-bmp-v0.md](knowledge/imageview-bmp-v0.md) | Observation + Decision | Active — BMP only; 24-bpp / PNG / JPEG / subdir walk deferred | 2026-05-02 |
