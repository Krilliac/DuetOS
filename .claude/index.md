...
| Linux ABI app coverage — synxtest pipeline + first-slice findings (build flags inc. -mno-sse, -mno-mmx; getpid Process::pid bug; getdents64 -ENOTDIR errno; 2 dead-on-arrival smokes fixed) | [knowledge/linux-app-coverage-pattern-v0.md](knowledge/linux-app-coverage-pattern-v0.md) | Pattern + Observation + Issue | Active | 2026-05-02 |
