...
| FaultReact v0 — self-defensive fault-reaction dispatcher (per-domain policy + kernel-owned floor + DriverFault wired) | [knowledge/fault-react-v0.md](knowledge/fault-react-v0.md) | Decision + Pattern + Observation | Active — DriverFault wired; trap-path / ubsan / runtime_checker wiring deferred | 2026-05-01 |
