...
| Smoke PE suite v5 — expanded to 44 apps (+interlock/fiber/profile/clipboard/windowclass/wow64/mathlib/stdio) + psapi/timezone/console-SBI/fs impls covering 213 PASS Win32 APIs | [knowledge/smoke-pe-suite-v5.md](knowledge/smoke-pe-suite-v5.md) | Observation + Pattern + Issue | Active | 2026-04-30 |
