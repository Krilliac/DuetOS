...
| FS write-rate guard + canary wall — v1 ransomware defense (multi-window 1 s/5 min/1 h byte caps + canary-path/suspicious-extension wall; 4 new HealthIssues, 2 new KillReasons; wired into Win32 SYS_FILE_{WRITE,CREATE} + Linux sys_write/copy_file_range/unlink/rename/openat-O_CREAT; 3 attack_sim entries: burst-tier, low-and-slow tier, canary-touch) | [knowledge/fs-write-rate-guard-v0.md](knowledge/fs-write-rate-guard-v0.md) | Decision + Pattern + Observation | Active | 2026-05-03 |
