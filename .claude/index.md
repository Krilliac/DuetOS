...
| Smoke PE suite v6 — expanded to 52 apps (+nls/services/eventlog/sound/multimon/power/heap/thread2) + wininet/winhttp sentinel handles covering 242 PASS Win32 APIs | [knowledge/smoke-pe-suite-v6.md](knowledge/smoke-pe-suite-v6.md) | Observation + Pattern + Issue | Active | 2026-04-30 |
