...
| Rasterizer / compositor / userland-shell — multi-slice plan (shadow framebuffer → true alpha → TTF parser → TTF rasterizer → userland libc + ELF build → prompt shell → SVG loader) | [knowledge/rasterizer-compositor-shell-plan.md](knowledge/rasterizer-compositor-shell-plan.md) | Plan | All numbered slices landed 2026-04-29; content-only follow-ups remain (drop a real TTF font, embed wallpaper SVGs) | 2026-04-29 |
