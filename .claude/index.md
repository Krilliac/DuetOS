...
| Linux ABI app coverage — synxtest + synfs pipelines + slice findings (build flags inc. -mno-sse, -mno-mmx; getpid Process::pid bug; getdents64 -ENOTDIR errno; 2 dead-on-arrival smokes fixed; openat O_CREAT pending-create flag; mkdir/rmdir errno restoration; copy_file_range kernel-VA bypass) | [knowledge/linux-app-coverage-pattern-v0.md](knowledge/linux-app-coverage-pattern-v0.md) | Pattern + Observation + Issue | Active | 2026-05-02 |
