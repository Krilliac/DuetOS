...
| native | 204 | `SYS_DIAG_FAULT_INJECT` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 205 | `SYS_DLL_LOAD_FROM_PATH` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 206 | `SYS_COMPAT_QUERY` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 207 | `SYS_MODULE_BASE_BY_VA` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 208 | `SYS_WAIT_ON_ADDRESS` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 209 | `SYS_WAKE_BY_ADDRESS` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 210 | `SYS_AUDIO_WRITE` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 211 | `SYS_VK_CALL` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 212 | `SYS_RANDOM_BYTES` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
| native | 213 | `SYS_IOCP_POST` | implemented | `kernel/syscall/syscall.h::SyscallNumber` | none (native syscall entry) |
