 ...
 *
 * The table is produced at build time by `tools/build/gen-symbols.sh`, which
 ...
 *     `tools/debug/symbolize.sh` for that.
 *
...
/// initialiser. Keep this struct in sync with `tools/build/gen-symbols.sh`.
struct SymbolEntry
{
