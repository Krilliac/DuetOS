...
// DoOpen / DoClose moved to syscall_file.cpp.
...
// FillStatFromEntry moved to syscall_file.cpp (its only callers,
// DoStat / DoFstat, live there).

// DoStat / DoFstat moved to syscall_file.cpp.
