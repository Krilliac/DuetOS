 ...
 *   - SeIncBasePriorityPriv. (LUID 14) → kCapSchedPriority
 *
 ...
 * role table, and on a "Yes + correct password" outcome installs a
 * deadline-authoritative lease for the role's configured window.
