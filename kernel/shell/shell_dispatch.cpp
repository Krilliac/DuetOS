...
const char* const kCommandSet[] = {
    ...
    "rand",     "flushtlb",  "checksum",   "repeat",      "kill",      "exec",       "unzip",       "metrics",
    "trace",    "read",      "guard",      "top",         "fatcat",    "fatls",      "fatwrite",    "fatappend",
    "fatnew",   "fatrm",     "fattrunc",   "fatmkdir",    "fatrmdir",  "linuxexec",  "translate",   "smbios",
    ...
    "beep",     "inspect",   "theme",      "addr2sym",    "cap-audit", "monitor",    "secevents",   "events",
    ...
    "bench",    "dbg",       "dfix",       "drshd",       "pe-triage", "caplog",     "live-update", "fault-inject",
};
