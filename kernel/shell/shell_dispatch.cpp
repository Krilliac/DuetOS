...
const char* const kCommandSet[] = {
    ...
    "fatappend",    "fatnew",    "fatrm",     "fattrunc",   "fatmkdir",    "fatrmdir",   "linuxexec", "translate",
    ...
    "poweroff",     "beep",      "inspect",   "theme",      "addr2sym",    "cap-audit",  "monitor",   "secevents",
    ...
    "stress",       "bench",     "dbg",       "dfix",       "drshd",       "pe-triage",  "caplog",    "live-update",
    "fault-inject",
};
