...
const char* const kCommandSet[] = {
    ...
    "hwmon",      "vbe",       "ping",     "nslookup",  "ntp",      "http",      "shutdown",   "poweroff",  "beep",
    "inspect",    "theme",     "addr2sym", "cap-audit", "monitor",  "secevents", "events",     "policy",    "purple",
    "purpleteam", "mkdir",     "rmdir",    "truncate",  "realpath", "id",        "groups",     "nproc",     "arch",
    "tty",        "type",      "printenv", "df",        "du",       "loadavg",   "clearhist",  "pause",     "yes",
    "sync",       "port",      "assert",   "watch",     "script",   "exit",      "mkfs",       "lastdump",
};
