...
const char* const kCommandSet[] = {
    ...
    "curl",        "metrics",      "trace",    "read",      "guard",      "top",         "fatcat",    "fatls",
    "fatwrite",    "fatappend",    "fatnew",   "fatrm",     "fattrunc",   "fatmkdir",    "fatrmdir",  "linuxexec",
    "translate",   "smbios",       "power",    "battery",   "thermal",    "temp",        "hw",        "hardware",
    "gpu",         "lsgpu",        "gfx",      "nic",       "lsnic",      "ip",          "arp",       "ipv4",
    "uuid",        "uuidgen",      "health",   "checkup",   "attacksim",  "redteam",     "memdump",   "leakcheck",
    "ifconfig",    "netinfo",      "dhcp",     "route",     "netscan",    "wifi",        "firewall",  "fwpolicy",
    "fwtrace",     "crtrace",      "crprobe",  "net",       "usbnet",     "instr",       "dumpstate", "bp",
    "breakpoint",  "login",        "logout",   "passwd",    "useradd",    "userdel",     "users",     "who",
    "su",          "idlelock",     "hwmon",    "vbe",       "ping",       "nslookup",    "ntp",       "http",
    "shutdown",    "poweroff",     "beep",     "inspect",   "theme",      "addr2sym",    "cap-audit", "monitor",
    ...
    "loadtest",    "stress",       "bench",    "dbg",       "dfix",       "drshd",       "pe-triage", "caplog",
    "live-update", "fault-inject",
};
