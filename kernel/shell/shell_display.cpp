...
void CmdGfx(u32 argc, char** argv)
{
    ...
    ConsoleWriteChar('\n');
    ConsoleWrite("  SPIR-V interp: programs-built=");
    WriteU64Dec(s.vk_spirv_programs_built);
    ConsoleWrite(" build-failures=");
    WriteU64Dec(s.vk_spirv_program_build_failures);
    ConsoleWrite(" executions=");
    WriteU64Dec(s.vk_spirv_entry_point_executions);
    ConsoleWrite(" step-budget-exhausted=");
    WriteU64Dec(s.vk_spirv_step_budget_exhausted);
    ConsoleWriteChar('\n');
    ConsoleWrite("  Shader raster: painted-draws=");
    WriteU64Dec(s.vk_shader_raster_draws_painted);
    ConsoleWrite(" skipped-draws=");
    WriteU64Dec(s.vk_shader_raster_draws_skipped);
    ConsoleWriteChar('\n');
