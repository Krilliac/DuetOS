...
impl BitmapAllocator {
    ...
    pub fn find_run_with_pinned(&self, n: u32, pinned: Option<&[u8; BLOCK_SIZE]>) -> Option<u32> {
    ...
    pub fn alloc_run_with_pinned(&mut self, n: u32, pinned: Option<&[u8; BLOCK_SIZE]>) -> Option<u32> {
