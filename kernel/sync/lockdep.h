...
/// the resumed task's on the way back in (top of
/// `SchedFinishTaskSwitch`, which every task — resumed or fresh —
/// hits first). Spinlocks are never live across a switch except
