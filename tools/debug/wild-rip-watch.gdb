...
printf "                    (gdb) watch *(unsigned long*)(\\$1 + 0xfff8)\n"
printf "                 where 0xfff8 = kKernelStackBytes (0x10000) - 8.\n"
printf "                 stack_base is the USABLE base returned by\n"
printf "                 AllocateKernelStack (post-guard-page); slot_top =\n"
printf "                 stack_base + 0x10000, trampoline RA slot = slot_top - 8.\n"
