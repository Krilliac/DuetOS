...
class ServicePackageCiContract(unittest.TestCase):
    ...
    def test_typed_binding_stays_fail_closed_until_activation_is_bound(self) -> None:
        self.assertIn("kBootServicePackageAuthorityBound", self.cmake)
        self.assertIn("!duetos::core::generated::kBootServicePackageBootstrapPlansBound", self.cmake)
        self.assertIn("!duetos::core::generated::kBootServicePackageActivationReady", self.cmake)
