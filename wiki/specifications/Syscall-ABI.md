...
| 130 | `SYS_REGISTRY` |
| 131 | `SYS_PROCESS_OPEN` |
| 132 | `SYS_PROCESS_VM_READ` |
| 133 | `SYS_PROCESS_VM_WRITE` |
| 134 | `SYS_PROCESS_VM_QUERY` |
| 135 | `SYS_THREAD_SUSPEND` |
| 136 | `SYS_THREAD_RESUME` |
| 137 | `SYS_THREAD_GET_CONTEXT` |
| 138 | `SYS_THREAD_SET_CONTEXT` |
| 139 | `SYS_THREAD_OPEN` |
| 140 | `SYS_SECTION_CREATE` |
| 141 | `SYS_SECTION_MAP` |
| 142 | `SYS_SECTION_UNMAP` |
| 143 | `SYS_FILE_UNLINK` |
| 144 | `SYS_FILE_RENAME` |
| 145 | `SYS_PROCESS_TERMINATE` |
...
| 167 | `SYS_JOB_QUERY` |
| 168 | `SYS_JOB_CLOSE` |
| 169 | `SYS_TOKEN_ADJUST` |
| 170 | `SYS_WIN_GET_MOUSE_DELTA` |
| 171 | `SYS_STDIN_READ` |
| 172 | `SYS_DLL_BASE_BY_NAME` |
...
| 222 | `SYS_FLS_GET` |
| 223 | `SYS_FLS_SET` |
| 224 | `SYS_GDI_CREATE_CURSOR_RGBA` |
| 225 | `SYS_GDI_CREATE_FONT` |
