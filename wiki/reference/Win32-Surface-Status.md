...
**`ntdll.dll`** — 107 imports thunked: 94 REAL, 13 NOOP.
...
| `NtYieldExecution` | NOOP | `kOffCritSecNop` |
| `RtlAllocateHeap` | REAL | `kOffHeapAlloc` |
| `RtlCompareMemory` | NOOP | `kOffReturnZero` |
| `RtlCopyMemory` | REAL | `kOffMemmove` |
| `RtlCreateHeap` | NOOP | `kOffReturnZero` |
| `RtlDeleteCriticalSection` | NOOP | `kOffCritSecNop` |
| `RtlDestroyHeap` | NOOP | `kOffReturnZero` |
| `RtlEnterCriticalSection` | REAL | `kOffEnterCritSecReal` |
| `RtlFillMemory` | NOOP | `kOffCritSecNop` |
| `RtlFreeHeap` | REAL | `kOffHeapFree` |
| `RtlFreeUnicodeString` | NOOP | `kOffCritSecNop` |
| `RtlGetLastWin32Error` | REAL | `kOffGetLastError` |
| `RtlInitAnsiString` | NOOP | `kOffCritSecNop` |
| `RtlInitializeCriticalSection` | REAL | `kOffInitCritSec` |
| `RtlInitUnicodeString` | NOOP | `kOffCritSecNop` |
| `RtlLeaveCriticalSection` | REAL | `kOffLeaveCritSecReal` |
| `RtlMoveMemory` | REAL | `kOffMemmove` |
| `RtlNtStatusToDosError` | NOOP | `kOffReturnZero` |
| `RtlReAllocateHeap` | REAL | `kOffHeapRealloc` |
| `RtlRunOnceExecuteOnce` | NOOP | `kOffReturnZero` |
...
| `RtlZeroMemory` | NOOP | `kOffCritSecNop` |
...
| `ZwYieldExecution` | NOOP | `kOffCritSecNop` |
...
**`kernel32.dll`** — 410 imports thunked: 185 REAL, 225 NOOP.

| Method | Status | Routed to |
|--------|--------|-----------|
| `AcquireSRWLockExclusive` | REAL | `kOffSrwAcquireExcl` |
| `AcquireSRWLockShared` | REAL | `kOffSrwAcquireExcl` |
| `AddDllDirectory` | NOOP | `kOffReturnZero` |
| `AddVectoredContinueHandler` | NOOP | `kOffReturnZero` |
| `AddVectoredExceptionHandler` | NOOP | `kOffReturnZero` |
| `AreFileApisANSI` | NOOP | `kOffReturnOne` |
...
| `ConnectNamedPipe` | NOOP | `kOffReturnZero` |
| `ConvertFiberToThread` | NOOP | `kOffReturnOne` |
| `ConvertThreadToFiber` | NOOP | `kOffReturnZero` |
| `ConvertThreadToFiberEx` | NOOP | `kOffReturnZero` |
| `CopyFileW` | NOOP | `kOffReturnOne` |
| `CreateConsoleScreenBuffer` | REAL | `kOffReturnMinus1` |
| `CreateDirectoryW` | NOOP | `kOffReturnOne` |
...
| `CreateFiber` | NOOP | `kOffReturnZero` |
| `CreateFiberEx` | NOOP | `kOffReturnZero` |
| `CreateFileA` | REAL | `kOffReturnMinus1` |
| `CreateFileMappingA` | NOOP | `kOffReturnZero` |
| `CreateFileMappingA` | NOOP | `kOffReturnZero` |
| `CreateFileMappingW` | NOOP | `kOffReturnZero` |
| `CreateFileMappingW` | NOOP | `kOffReturnZero` |
...
| `CreateRemoteThread` | NOOP | `kOffReturnZero` |
| `CreateRemoteThread` | NOOP | `kOffReturnZero` |
...
| `DeleteCriticalSection` | NOOP | `kOffCritSecNop` |
| `DeleteFiber` | NOOP | `kOffCritSecNop` |
| `DeleteFileA` | NOOP | `kOffReturnOne` |
| `DeleteFileW` | NOOP | `kOffReturnOne` |
| `DeviceIoControl` | NOOP | `kOffReturnZero` |
| `DisableThreadLibraryCalls` | NOOP | `kOffReturnOne` |
| `DisconnectNamedPipe` | NOOP | `kOffReturnOne` |
| `DuplicateHandle` | NOOP | `kOffReturnZero` |
| `DuplicateHandle` | NOOP | `kOffReturnZero` |
| `EncodePointer` | REAL | `kOffDecodePointer` |
| `EnterCriticalSection` | REAL | `kOffEnterCritSecReal` |
| `EnumSystemFirmwareTables` | NOOP | `kOffReturnZero` |
| `EnumSystemLocalesA` | NOOP | `kOffReturnOne` |
| `EnumSystemLocalesW` | NOOP | `kOffReturnOne` |
| `ExitProcess` | REAL | `kOffExitProcess` |
| `ExitThread` | REAL | `kOffExitThread` |
| `ExpandEnvironmentStringsA` | NOOP | `kOffReturnZero` |
| `ExpandEnvironmentStringsW` | NOOP | `kOffReturnZero` |
| `FileTimeToSystemTime` | REAL | `kOffFileTimeToSystemTime` |
| `FillConsoleOutputAttribute` | NOOP | `kOffReturnOne` |
| `FillConsoleOutputCharacterA` | NOOP | `kOffReturnOne` |
| `FillConsoleOutputCharacterW` | NOOP | `kOffReturnOne` |
| `FindFirstFileExA` | REAL | `kOffReturnMinus1` |
| `FindFirstFileExW` | REAL | `kOffReturnMinus1` |
| `FindFirstVolumeW` | REAL | `kOffReturnMinus1` |
| `FindNextVolumeW` | NOOP | `kOffReturnZero` |
| `FindResourceA` | NOOP | `kOffReturnZero` |
| `FindResourceExW` | NOOP | `kOffReturnZero` |
| `FindResourceW` | NOOP | `kOffReturnZero` |
| `FindVolumeClose` | NOOP | `kOffReturnOne` |
...
| `FlushConsoleInputBuffer` | NOOP | `kOffReturnOne` |
| `FlushFileBuffers` | NOOP | `kOffReturnOne` |
| `FlushViewOfFile` | NOOP | `kOffReturnOne` |
| `FormatMessageA` | REAL | `kOffFormatMessageA` |
| `FormatMessageW` | NOOP | `kOffReturnZero` |
| `FreeEnvironmentStringsA` | NOOP | `kOffReturnOne` |
| `FreeEnvironmentStringsA` | REAL | `kOffFreeEnvStringsW` |
| `FreeEnvironmentStringsW` | REAL | `kOffFreeEnvStringsW` |
| `FreeLibrary` | NOOP | `kOffReturnOne` |
| `FreeLibraryAndExitThread` | REAL | `kOffExitThread` |
| `GenerateConsoleCtrlEvent` | NOOP | `kOffReturnOne` |
...
| `GetConsoleWindow` | NOOP | `kOffReturnZero` |
| `GetCPInfo` | NOOP | `kOffReturnOne` |
| `GetCPInfoExA` | NOOP | `kOffReturnOne` |
| `GetCPInfoExW` | NOOP | `kOffReturnOne` |
...
| `GetCurrentProcessorNumber` | NOOP | `kOffReturnZero` |
| `GetCurrentThread` | REAL | `kOffGetCurrentThread` |
| `GetCurrentThreadId` | REAL | `kOffGetCurrentThreadId` |
| `GetDiskFreeSpaceA` | NOOP | `kOffReturnOne` |
| `GetDiskFreeSpaceExA` | NOOP | `kOffReturnOne` |
| `GetDriveTypeA` | REAL | `kOffGetDriveType` |
| `GetDriveTypeW` | REAL | `kOffGetDriveType` |
| `GetDynamicTimeZoneInformation` | NOOP | `kOffReturnOne` |
| `GetEnvironmentStrings` | REAL | `kOffGetEnvBlockW` |
| `GetEnvironmentStringsA` | NOOP | `kOffReturnZero` |
| `GetEnvironmentStringsW` | REAL | `kOffGetEnvBlockW` |
| `GetEnvironmentVariableA` | NOOP | `kOffReturnZero` |
| `GetEnvironmentVariableW` | NOOP | `kOffReturnZero` |
| `GetErrorMode` | NOOP | `kOffReturnZero` |
...
| `GetFileAttributesExA` | NOOP | `kOffReturnZero` |
| `GetFileAttributesExW` | NOOP | `kOffReturnZero` |
| `GetFileAttributesExW` | NOOP | `kOffReturnZero` |
...
| `GetFullPathNameA` | NOOP | `kOffReturnZero` |
| `GetHandleInformation` | NOOP | `kOffReturnZero` |
| `GetLastError` | REAL | `kOffGetLastError` |
| `GetLocaleInfoA` | NOOP | `kOffReturnZero` |
| `GetLocaleInfoEx` | NOOP | `kOffReturnZero` |
| `GetLocaleInfoW` | NOOP | `kOffReturnZero` |
| `GetLocalTime` | REAL | `kOffGetSystemTimeSt` |
| `GetLogicalDrives` | REAL | `kOffGetLogicalDrives` |
| `GetLogicalProcessorInformation` | NOOP | `kOffReturnZero` |
| `GetLogicalProcessorInformationEx` | NOOP | `kOffReturnZero` |
...
| `GetModuleHandleExA` | NOOP | `kOffReturnZero` |
| `GetModuleHandleExW` | NOOP | `kOffReturnZero` |
| `GetModuleHandleW` | REAL | `kOffGetModuleHandleW` |
| `GetNativeSystemInfo` | REAL | `kOffGetSystemInfo` |
| `GetNumaHighestNodeNumber` | NOOP | `kOffReturnZero` |
| `GetNumberOfConsoleInputEvents` | NOOP | `kOffReturnZero` |
| `GetNumberOfConsoleInputEvents` | NOOP | `kOffReturnOne` |
| `GetOEMCP` | REAL | `kOffGetConsoleCP` |
| `GetOverlappedResult` | NOOP | `kOffReturnOne` |
| `GetOverlappedResultEx` | NOOP | `kOffReturnOne` |
| `GetPriorityClass` | REAL | `kOffReturnPrioNormal` |
| `GetProcAddress` | REAL | `kOffGetProcAddressReal` |
| `GetProcessHeap` | NOOP | `kOffGetProcessHeap` |
...
| `GetStringTypeA` | NOOP | `kOffReturnOne` |
| `GetStringTypeExW` | NOOP | `kOffReturnOne` |
| `GetStringTypeW` | NOOP | `kOffReturnOne` |
| `GetSystemDefaultLCID` | NOOP | `kOffReturnZero` |
| `GetSystemDefaultUILanguage` | NOOP | `kOffReturnZero` |
| `GetSystemDirectoryA` | REAL | `kOffGetWinDirW` |
| `GetSystemDirectoryW` | REAL | `kOffGetWinDirW` |
| `GetSystemFirmwareTable` | NOOP | `kOffReturnZero` |
...
| `GetThreadId` | NOOP | `kOffReturnZero` |
| `GetThreadIdealProcessorEx` | NOOP | `kOffReturnOne` |
| `GetThreadLocale` | NOOP | `kOffReturnZero` |
| `GetThreadPriority` | NOOP | `kOffReturnZero` |
| `GetThreadTimes` | REAL | `kOffGetProcessTimes` |
| `GetTickCount` | REAL | `kOffGetTickCount` |
| `GetTickCount64` | REAL | `kOffGetTickCount` |
| `GetTimeZoneInformation` | NOOP | `kOffReturnOne` |
| `GetUserDefaultLCID` | NOOP | `kOffReturnZero` |
| `GetUserDefaultUILanguage` | NOOP | `kOffReturnZero` |
| `GetVersionExA` | REAL | `kOffGetVersionExW` |
| `GetVersionExW` | REAL | `kOffGetVersionExW` |
| `GetVolumeInformationA` | NOOP | `kOffReturnOne` |
| `GetVolumeInformationW` | NOOP | `kOffReturnOne` |
...
| `HeapCompact` | NOOP | `kOffReturnZero` |
| `HeapCreate` | NOOP | `kOffGetProcessHeap` |
| `HeapDestroy` | NOOP | `kOffReturnOne` |
| `HeapFree` | REAL | `kOffHeapFree` |
| `HeapReAlloc` | REAL | `kOffHeapRealloc` |
| `HeapSize` | REAL | `kOffHeapSize` |
| `InitializeConditionVariable` | NOOP | `kOffCritSecNop` |
...
| `InitializeInitOnce` | NOOP | `kOffCritSecNop` |
| `InitializeSListHead` | REAL | `kOffInitSListHead` |
| `InitializeSRWLock` | REAL | `kOffSrwInit` |
| `InitOnceBeginInitialize` | NOOP | `kOffReturnOne` |
| `InitOnceComplete` | NOOP | `kOffReturnOne` |
...
| `InterlockedFlushSList` | NOOP | `kOffReturnZero` |
...
| `InterlockedPopEntrySList` | NOOP | `kOffReturnZero` |
| `InterlockedPushEntrySList` | NOOP | `kOffReturnZero` |
| `InterlockedXor` | REAL | `kOffInterlockedXor` |
| `InterlockedXor64` | REAL | `kOffInterlockedXor64` |
| `IsBadCodePtr` | NOOP | `kOffReturnZero` |
| `IsBadReadPtr` | NOOP | `kOffReturnZero` |
| `IsBadStringPtrA` | NOOP | `kOffReturnZero` |
| `IsBadStringPtrW` | NOOP | `kOffReturnZero` |
| `IsBadWritePtr` | NOOP | `kOffReturnZero` |
| `IsDBCSLeadByte` | NOOP | `kOffReturnZero` |
| `IsDebuggerPresent` | NOOP | `kOffReturnZero` |
| `IsDebuggerPresent` | NOOP | `kOffReturnZero` |
| `IsProcessorFeaturePresent` | NOOP | `kOffReturnOne` |
| `IsThreadAFiber` | NOOP | `kOffReturnZero` |
| `IsValidCodePage` | NOOP | `kOffReturnOne` |
| `IsValidLocale` | NOOP | `kOffReturnOne` |
| `IsWow64Process` | REAL | `kOffIsWow64` |
| `IsWow64Process2` | REAL | `kOffIsWow64` |
| `LCMapStringA` | NOOP | `kOffReturnZero` |
| `LCMapStringEx` | NOOP | `kOffReturnZero` |
| `LCMapStringW` | NOOP | `kOffReturnZero` |
| `LeaveCriticalSection` | REAL | `kOffLeaveCritSecReal` |
| `LoadLibraryA` | NOOP | `kOffReturnZero` |
| `LoadLibraryExA` | NOOP | `kOffReturnZero` |
| `LoadLibraryExW` | NOOP | `kOffReturnZero` |
| `LoadLibraryW` | NOOP | `kOffReturnZero` |
| `LoadResource` | NOOP | `kOffReturnZero` |
| `LockFile` | NOOP | `kOffReturnOne` |
| `LockFileEx` | NOOP | `kOffReturnOne` |
| `LockResource` | NOOP | `kOffReturnZero` |
...
| `MapViewOfFile` | NOOP | `kOffReturnZero` |
| `MapViewOfFileEx` | NOOP | `kOffReturnZero` |
| `MoveFileA` | NOOP | `kOffReturnOne` |
| `MoveFileExA` | NOOP | `kOffReturnOne` |
| `MoveFileExW` | NOOP | `kOffReturnOne` |
| `MoveFileW` | NOOP | `kOffReturnOne` |
| `MsgWaitForMultipleObjects` | NOOP | `kOffReturnZero` |
| `MsgWaitForMultipleObjectsEx` | NOOP | `kOffReturnZero` |
| `MultiByteToWideChar` | REAL | `kOffMBtoWC` |
| `OpenFileMappingA` | NOOP | `kOffReturnZero` |
| `OpenFileMappingW` | NOOP | `kOffReturnZero` |
| `OpenFileMappingW` | NOOP | `kOffReturnZero` |
| `OpenProcess` | REAL | `kOffOpenProcess` |
| `OpenThread` | NOOP | `kOffReturnZero` |
| `OutputDebugStringA` | REAL | `kOffOutputDebugStringA` |
| `OutputDebugStringW` | REAL | `kOffOutputDebugStringW` |
| `PeekConsoleInputW` | NOOP | `kOffReturnZero` |
| `PeekConsoleInputW` | NOOP | `kOffReturnZero` |
| `PeekNamedPipe` | NOOP | `kOffReturnZero` |
| `Process32First` | NOOP | `kOffReturnZero` |
| `Process32FirstW` | NOOP | `kOffReturnZero` |
| `Process32Next` | NOOP | `kOffReturnZero` |
| `Process32NextW` | NOOP | `kOffReturnZero` |
| `QueryDepthSList` | NOOP | `kOffReturnZero` |
| `QueryPerformanceCounter` | REAL | `kOffQpcNs` |
| `QueryPerformanceFrequency` | REAL | `kOffQpfNs` |
| `RaiseException` | REAL | `kOffRaiseException` |
| `ReadConsoleA` | NOOP | `kOffReturnZero` |
| `ReadConsoleInputA` | NOOP | `kOffReturnZero` |
| `ReadConsoleInputW` | NOOP | `kOffReturnZero` |
| `ReadConsoleInputW` | NOOP | `kOffReturnZero` |
| `ReadConsoleW` | NOOP | `kOffReturnZero` |
| `ReadDirectoryChangesW` | NOOP | `kOffReturnZero` |
| `ReadFile` | REAL | `kOffReadFile` |
| `ReadProcessMemory` | NOOP | `kOffReturnZero` |
| `RegisterApplicationRestart` | NOOP | `kOffReturnZero` |
...
| `RemoveDirectoryW` | NOOP | `kOffReturnOne` |
| `RemoveDllDirectory` | NOOP | `kOffReturnOne` |
| `RemoveVectoredExceptionHandler` | NOOP | `kOffReturnZero` |
| `ResetEvent` | REAL | `kOffResetEventReal` |
| `ResumeThread` | NOOP | `kOffReturnZero` |
| `RtlCaptureContext` | NOOP | `kOffReturnZero` |
| `RtlCaptureStackBackTrace` | NOOP | `kOffReturnZero` |
| `RtlDecodePointer` | REAL | `kOffDecodePointer` |
| `RtlEncodePointer` | REAL | `kOffDecodePointer` |
| `RtlLookupFunctionEntry` | NOOP | `kOffReturnZero` |
| `RtlVirtualUnwind` | NOOP | `kOffReturnZero` |
| `SetConsoleActiveScreenBuffer` | NOOP | `kOffReturnOne` |
| `SetConsoleCP` | NOOP | `kOffReturnOne` |
| `SetConsoleCtrlHandler` | NOOP | `kOffReturnOne` |
| `SetConsoleCursorPosition` | NOOP | `kOffReturnOne` |
| `SetConsoleMode` | NOOP | `kOffReturnOne` |
| `SetConsoleOutputCP` | NOOP | `kOffReturnOne` |
| `SetConsoleScreenBufferSize` | NOOP | `kOffReturnOne` |
| `SetConsoleTextAttribute` | NOOP | `kOffReturnOne` |
| `SetCurrentDirectoryA` | NOOP | `kOffReturnOne` |
| `SetCurrentDirectoryW` | NOOP | `kOffReturnOne` |
| `SetDefaultDllDirectories` | NOOP | `kOffReturnOne` |
| `SetEndOfFile` | NOOP | `kOffReturnOne` |
| `SetEnvironmentVariableA` | NOOP | `kOffReturnOne` |
| `SetEnvironmentVariableW` | NOOP | `kOffReturnOne` |
| `SetErrorMode` | NOOP | `kOffReturnZero` |
| `SetEvent` | REAL | `kOffSetEventReal` |
| `SetFileAttributesA` | NOOP | `kOffReturnOne` |
| `SetFileAttributesW` | NOOP | `kOffReturnOne` |
| `SetFilePointer` | NOOP | `kOffReturnZero` |
| `SetFilePointerEx` | REAL | `kOffSetFilePtrEx` |
| `SetFileTime` | NOOP | `kOffReturnOne` |
| `SetHandleInformation` | NOOP | `kOffReturnOne` |
| `SetLastError` | REAL | `kOffSetLastError` |
| `SetPriorityClass` | NOOP | `kOffReturnOne` |
| `SetProcessAffinityMask` | NOOP | `kOffReturnOne` |
| `SetSearchPathMode` | NOOP | `kOffReturnOne` |
| `SetStdHandle` | NOOP | `kOffReturnOne` |
| `SetSystemTime` | NOOP | `kOffReturnOne` |
| `SetThreadAffinityMask` | NOOP | `kOffReturnOne` |
| `SetThreadErrorMode` | NOOP | `kOffReturnOne` |
| `SetThreadIdealProcessor` | NOOP | `kOffReturnZero` |
...
| `SleepConditionVariableCS` | NOOP | `kOffReturnOne` |
| `SleepConditionVariableSRW` | NOOP | `kOffReturnOne` |
| `SleepEx` | REAL | `kOffSleep` |
| `SwitchToFiber` | NOOP | `kOffCritSecNop` |
...
| `UnlockFile` | NOOP | `kOffReturnOne` |
| `UnlockFileEx` | NOOP | `kOffReturnOne` |
| `UnmapViewOfFile` | NOOP | `kOffReturnOne` |
| `UnregisterApplicationRestart` | NOOP | `kOffReturnZero` |
| `VerifyVersionInfoA` | NOOP | `kOffReturnOne` |
| `VerifyVersionInfoW` | NOOP | `kOffReturnOne` |
| `VerSetConditionMask` | NOOP | `kOffReturnZero` |
...
| `VirtualLock` | NOOP | `kOffReturnOne` |
| `VirtualProtect` | REAL | `kOffVirtualProtect` |
| `VirtualProtectEx` | REAL | `kOffVirtualProtect` |
| `VirtualQuery` | NOOP | `kOffReturnZero` |
| `VirtualQueryEx` | NOOP | `kOffReturnZero` |
| `VirtualUnlock` | NOOP | `kOffReturnOne` |
| `WaitForInputIdle` | NOOP | `kOffReturnZero` |
...
| `WaitNamedPipeA` | NOOP | `kOffReturnZero` |
| `WaitNamedPipeW` | NOOP | `kOffReturnZero` |
| `WakeAllConditionVariable` | NOOP | `kOffCritSecNop` |
| `WakeConditionVariable` | NOOP | `kOffCritSecNop` |
...
| `WriteProcessMemory` | NOOP | `kOffReturnZero` |
<!-- AUTO:thunks-by-dll END -->
...
**`ucrtbase.dll`** — 59 imports thunked: 37 REAL, 22 NOOP.

| Method | Status | Routed to |
|--------|--------|-----------|
| `___mb_cur_max_func` | NOOP | `kOffReturnOne` |
| `__acrt_iob_func` | REAL | `kOffPErrno` |
| `__C_specific_handler` | NOOP | `kOffReturnZero` |
...
| `__stdio_common_vfprintf` | NOOP | `kOffReturnZero` |
| `__stdio_common_vfwprintf` | NOOP | `kOffReturnZero` |
| `_aligned_free` | REAL | `kOffFree` |
| `_aligned_free` | REAL | `kOffFree` |
| `_aligned_malloc` | REAL | `kOffMalloc` |
| `_aligned_malloc` | REAL | `kOffMalloc` |
| `_callnewh` | NOOP | `kOffReturnZero` |
| `_clearfp` | NOOP | `kOffReturnZero` |
| `_errno` | REAL | `kOffPErrno` |
| `_exit` | REAL | `kOffExitProcess` |
| `_fileno` | REAL | `kOffReturnMinus1` |
| `_fseeki64` | NOOP | `kOffReturnZero` |
| `_ftelli64` | REAL | `kOffReturnMinus1` |
| `_initterm` | NOOP | `kOffReturnZero` |
| `_initterm_e` | NOOP | `kOffReturnZero` |
| `_msize` | NOOP | `kOffReturnZero` |
| `_register_thread_local_exe_atexit_callback` | NOOP | `kOffReturnZero` |
| `_seh_filter_exe` | NOOP | `kOffReturnZero` |
| `_set_invalid_parameter_handler` | NOOP | `kOffReturnZero` |
| `_setmode` | NOOP | `kOffReturnZero` |
| `_statusfp` | NOOP | `kOffReturnZero` |
| `_stricmp` | REAL | `kOffStrcmp` |
| `_strnicmp` | REAL | `kOffStrcmp` |
| `_wfopen` | NOOP | `kOffReturnZero` |
| `abort` | REAL | `kOffTerminate` |
| `atoi` | NOOP | `kOffReturnZero` |
| `atol` | NOOP | `kOffReturnZero` |
| `calloc` | REAL | `kOffCalloc` |
| `exit` | REAL | `kOffExitProcess` |
| `fflush` | NOOP | `kOffReturnZero` |
| `fgetc` | REAL | `kOffReturnMinus1` |
| `fputc` | REAL | `kOffFputc` |
| `fputs` | REAL | `kOffFputs` |
| `free` | REAL | `kOffFree` |
| `fwrite` | REAL | `kOffFwrite` |
| `getenv` | NOOP | `kOffReturnZero` |
...
| `strtol` | NOOP | `kOffReturnZero` |
| `strtoul` | NOOP | `kOffReturnZero` |
...
**`user32.dll`** — 100 imports thunked: 17 REAL, 83 NOOP.

| Method | Status | Routed to |
|--------|--------|-----------|
| `AnyPopup` | NOOP | `kOffReturnZero` |
| `BeginPaint` | REAL | `kOffWinBeginPaint` |
| `BlockInput` | NOOP | `kOffReturnZero` |
| `CallWindowProcA` | NOOP | `kOffReturnZero` |
| `CallWindowProcW` | NOOP | `kOffReturnZero` |
| `CharLowerW` | NOOP | `kOffReturnZero` |
| `CharUpperW` | NOOP | `kOffReturnZero` |
| `ClipCursor` | NOOP | `kOffReturnOne` |
| `CloseClipboard` | NOOP | `kOffReturnOne` |
| `CountClipboardFormats` | NOOP | `kOffReturnZero` |
| `CreateWindowExA` | NOOP | `kOffReturnOne` |
| `CreateWindowExW` | NOOP | `kOffReturnOne` |
| `DefWindowProcA` | NOOP | `kOffReturnZero` |
| `DefWindowProcW` | NOOP | `kOffReturnZero` |
| `DestroyWindow` | NOOP | `kOffReturnOne` |
...
| `EmptyClipboard` | NOOP | `kOffReturnOne` |
| `EnableWindow` | NOOP | `kOffReturnZero` |
| `EndPaint` | REAL | `kOffWinEndPaint` |
| `EnumClipboardFormats` | NOOP | `kOffReturnZero` |
| `FillRect` | REAL | `kOffGdiFillRectUser` |
| `FlashWindow` | NOOP | `kOffReturnZero` |
| `FlashWindowEx` | NOOP | `kOffReturnZero` |
| `GetActiveWindow` | NOOP | `kOffReturnZero` |
| `GetClientRect` | NOOP | `kOffReturnOne` |
| `GetClipboardData` | NOOP | `kOffReturnZero` |
| `GetCursor` | NOOP | `kOffReturnZero` |
| `GetCursorPos` | NOOP | `kOffReturnOne` |
| `GetDC` | REAL | `kOffWinGetDC` |
| `GetDesktopWindow` | NOOP | `kOffReturnZero` |
| `GetForegroundWindow` | NOOP | `kOffReturnZero` |
| `GetMessageA` | REAL | `kOffGetMessageA` |
| `GetMessageW` | REAL | `kOffGetMessageA` |
| `GetProcessWindowStation` | NOOP | `kOffReturnZero` |
| `GetSysColor` | REAL | `kOffGetSysColor` |
| `GetSysColorBrush` | REAL | `kOffGetSysColorBrush` |
| `GetSystemMenu` | NOOP | `kOffReturnZero` |
| `GetSystemMetrics` | NOOP | `kOffReturnZero` |
| `GetSystemMetrics` | NOOP | `kOffReturnZero` |
| `GetWindowRect` | NOOP | `kOffReturnOne` |
| `InvalidateRect` | REAL | `kOffWinInvalidateRect` |
| `IsClipboardFormatAvailable` | NOOP | `kOffReturnZero` |
| `IsIconic` | NOOP | `kOffReturnZero` |
| `IsWindow` | NOOP | `kOffReturnZero` |
| `IsWindowEnabled` | NOOP | `kOffReturnOne` |
| `IsWindowVisible` | NOOP | `kOffReturnOne` |
| `IsZoomed` | NOOP | `kOffReturnZero` |
| `LoadAcceleratorsA` | NOOP | `kOffReturnOne` |
| `LoadAcceleratorsW` | NOOP | `kOffReturnOne` |
| `LoadBitmapA` | NOOP | `kOffReturnOne` |
| `LoadBitmapW` | NOOP | `kOffReturnOne` |
| `LoadCursorA` | NOOP | `kOffReturnOne` |
| `LoadCursorW` | NOOP | `kOffReturnOne` |
| `LoadIconA` | NOOP | `kOffReturnOne` |
| `LoadIconW` | NOOP | `kOffReturnOne` |
| `LoadImageA` | NOOP | `kOffReturnOne` |
| `LoadImageW` | NOOP | `kOffReturnOne` |
| `LoadMenuA` | NOOP | `kOffReturnOne` |
| `LoadMenuW` | NOOP | `kOffReturnOne` |
| `LoadStringA` | NOOP | `kOffReturnZero` |
| `LoadStringW` | NOOP | `kOffReturnZero` |
| `LoadStringW` | NOOP | `kOffReturnZero` |
| `MessageBoxA` | NOOP | `kOffReturnOne` |
| `MessageBoxA` | NOOP | `kOffReturnOne` |
| `MessageBoxExA` | NOOP | `kOffReturnOne` |
| `MessageBoxExW` | NOOP | `kOffReturnOne` |
| `MessageBoxExW` | NOOP | `kOffReturnOne` |
| `MessageBoxW` | NOOP | `kOffReturnOne` |
| `MessageBoxW` | NOOP | `kOffReturnOne` |
| `MoveWindow` | NOOP | `kOffReturnOne` |
| `OpenClipboard` | NOOP | `kOffReturnZero` |
| `PeekMessageA` | REAL | `kOffPeekMessageA` |
| `PeekMessageW` | REAL | `kOffPeekMessageA` |
| `PostMessageA` | NOOP | `kOffReturnOne` |
| `PostMessageW` | NOOP | `kOffReturnOne` |
| `PostQuitMessage` | NOOP | `kOffReturnZero` |
| `PostThreadMessageA` | NOOP | `kOffReturnOne` |
| `PostThreadMessageW` | NOOP | `kOffReturnOne` |
| `RegisterClassA` | NOOP | `kOffReturnOne` |
| `RegisterClassExA` | NOOP | `kOffReturnOne` |
| `RegisterClassExW` | NOOP | `kOffReturnOne` |
| `RegisterClassW` | NOOP | `kOffReturnOne` |
| `ReleaseDC` | REAL | `kOffWinReleaseDC` |
| `SendMessageA` | NOOP | `kOffReturnZero` |
| `SendMessageW` | NOOP | `kOffReturnZero` |
| `SetClipboardData` | NOOP | `kOffReturnZero` |
| `SetCursor` | NOOP | `kOffReturnZero` |
| `SetCursorPos` | NOOP | `kOffReturnOne` |
| `SetWindowPos` | NOOP | `kOffReturnOne` |
| `ShowCursor` | NOOP | `kOffReturnZero` |
| `ShowWindow` | NOOP | `kOffReturnZero` |
| `TranslateAcceleratorA` | NOOP | `kOffReturnZero` |
| `TranslateAcceleratorW` | NOOP | `kOffReturnZero` |
| `TranslateMessage` | NOOP | `kOffReturnZero` |
| `UnregisterClassA` | NOOP | `kOffReturnOne` |
| `UnregisterClassW` | NOOP | `kOffReturnOne` |
...
**`gdi32.dll`** — 47 imports thunked: 25 REAL, 22 NOOP.

| Method | Status | Routed to |
|--------|--------|-----------|
| `BitBlt` | REAL | `kOffGdiBitBltDC` |
| `CreateBitmap` | NOOP | `kOffReturnOne` |
| `CreateBrushIndirect` | NOOP | `kOffReturnOne` |
| `CreateCompatibleBitmap` | REAL | `kOffGdiCreateCompatBmp` |
| `CreateCompatibleDC` | REAL | `kOffGdiCreateCompatDC` |
| `CreateDIBitmap` | NOOP | `kOffReturnOne` |
| `CreateDIBSection` | NOOP | `kOffReturnOne` |
| `CreateFontA` | NOOP | `kOffReturnOne` |
| `CreateFontIndirectA` | NOOP | `kOffReturnOne` |
| `CreateFontIndirectW` | NOOP | `kOffReturnOne` |
| `CreateFontW` | NOOP | `kOffReturnOne` |
...
| `ExtTextOutA` | NOOP | `kOffReturnOne` |
| `ExtTextOutW` | NOOP | `kOffReturnOne` |
| `FillRect` | REAL | `kOffGdiFillRectUser` |
| `FrameRect` | NOOP | `kOffReturnOne` |
| `GetDC` | NOOP | `kOffReturnOne` |
| `GetObjectA` | NOOP | `kOffReturnOne` |
| `GetObjectW` | NOOP | `kOffReturnOne` |
| `GetStockObject` | REAL | `kOffGdiGetStockObject` |
| `GetWindowDC` | NOOP | `kOffReturnOne` |
| `LineTo` | REAL | `kOffGdiLineTo` |
| `MoveToEx` | REAL | `kOffGdiMoveToEx` |
| `PatBlt` | REAL | `kOffGdiPatBlt` |
| `Polygon` | NOOP | `kOffReturnOne` |
| `Polyline` | NOOP | `kOffReturnOne` |
| `Rectangle` | REAL | `kOffGdiRectangleFilled` |
| `ReleaseDC` | NOOP | `kOffReturnOne` |
| `RestoreDC` | NOOP | `kOffReturnOne` |
| `SaveDC` | NOOP | `kOffReturnOne` |
| `SelectObject` | REAL | `kOffGdiSelectObject` |
| `SetBkColor` | REAL | `kOffGdiSetBkColor` |
| `SetBkMode` | REAL | `kOffGdiSetBkMode` |
| `SetMapMode` | NOOP | `kOffReturnOne` |
| `SetPixel` | REAL | `kOffGdiSetPixel` |
| `SetPixelV` | REAL | `kOffGdiSetPixel` |
| `SetTextAlign` | NOOP | `kOffReturnZero` |
...
**`ws2_32.dll`** — 8 imports thunked: 2 REAL, 6 NOOP.

| Method | Status | Routed to |
|--------|--------|-----------|
| `WSAAsyncSelect` | NOOP | `kOffReturnZero` |
| `WSAEnumNetworkEvents` | NOOP | `kOffReturnZero` |
| `WSAEventSelect` | NOOP | `kOffReturnZero` |
| `WSARecv` | NOOP | `kOffReturnZero` |
| `WSASend` | NOOP | `kOffReturnZero` |
| `WSASocketA` | REAL | `kOffReturnMinus1` |
| `WSASocketW` | REAL | `kOffReturnMinus1` |
| `WSAWaitForMultipleEvents` | NOOP | `kOffReturnZero` |
<!-- AUTO:thunks-by-dll END -->
