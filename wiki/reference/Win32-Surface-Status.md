...
>
> Ten x64 imports have crossed the fail-closed retirement gate.
...
> `GetCurrentThreadId`, `GetLastError`, and `SetLastError`. Callers
...
**`kernel32.dll`** — 403 imports thunked: 403 REAL.
