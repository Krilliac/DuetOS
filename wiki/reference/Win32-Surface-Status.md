...
>
> Twenty-two x64 imports have crossed the fail-closed retirement gate.
...
> `InterlockedExchange`, and `InterlockedCompareExchange`.
> Callers
...
**`kernel32.dll`** — 391 imports thunked: 391 REAL.
