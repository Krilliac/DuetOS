...
Source: `kernel/shell/*.cpp` — every `void Cmd*(...)` symbol appears here. Total: **223** handlers across **16** TUs.
...
| `kernel/shell/shell_storage.cpp` | `CmdLastdump`, `CmdLsblk`, `CmdLsgpt`, `CmdLsmod`, `CmdMkfs`, `CmdMkfsDuetfs`, `CmdMount` |
