...
Source: `kernel/shell/*.cpp` — every `void Cmd*(...)` symbol appears here. Total: **256** handlers across **19** TUs.
...
| `kernel/shell/shell_debug.cpp` | `CmdAddr2Sym`, `CmdBp`, `CmdCapAuditMode`, `CmdDomain`, `CmdDomainRestart`, `CmdDumpState`, `CmdFaultInject`, `CmdHealth`, `CmdInspect`, `CmdInspectArm`, `CmdInspectCapAudit`, `CmdInspectCounters`, `CmdInspectDomains`, `CmdInspectEntropy`, `CmdInspectFaultReact`, `CmdInspectGdb`, `CmdInspectHelp`, `CmdInspectIpc`, `CmdInspectLockdep`, `CmdInspectOpcodes`, `CmdInspectRcu`, `CmdInspectSecurity`, `CmdInspectSyscalls`, `CmdInspectSyscallsCaps`, `CmdInspectThreads`, `CmdInspectTracerStats`, `CmdInspectUptime`, `CmdInspectZones`, `CmdInstr`, `CmdKdbg`, `CmdLeakCheck`, `CmdLockdepPanic`, `CmdLogarea`, `CmdLogclock`, `CmdLogcolor`, `CmdLoglevel`, `CmdMemDump`, `CmdMetrics`, `CmdModule`, `CmdPerf`, `CmdPerfDump`, `CmdProbe`, `CmdTrace`, `CmdTracer`, `CmdTracerDump`, `CmdTracerKind` |
...
| `kernel/shell/shell_exec.cpp` | `CmdExec`, `CmdLinuxexec`, `CmdPeTriage`, `CmdRead`, `CmdReadelf`, `CmdTranslate`, `CmdUnzip` |
...
| `kernel/shell/shell_hardware.cpp` | `CmdCpuFeatures`, `CmdCpuid`, `CmdCr`, `CmdDpms`, `CmdFb`, `CmdGfx`, `CmdGpu`, `CmdHdaJacks`, `CmdHeap`, `CmdHeapLeaks`, `CmdHeapLeaksWatch`, `CmdHpet`, `CmdHw`, `CmdHwmon`, `CmdIo`, `CmdKbdStats`, `CmdLapic`, `CmdLspci`, `CmdMei`, `CmdMonitor`, `CmdMouseStats`, `CmdMsr`, `CmdPaging`, `CmdPeek`, `CmdPoke`, `CmdPower`, `CmdRflags`, `CmdSmbios`, `CmdSmp`, `CmdThermal`, `CmdTicks`, `CmdTsc`, `CmdVbe`, `CmdVtop`, `CmdWrmsr` |
...
| `kernel/shell/shell_process.cpp` | `CmdAffinity`, `CmdFree`, `CmdKill`, `CmdPs`, `CmdResume`, `CmdSpawn`, `CmdSuspend`, `CmdTop` |
...
| `kernel/shell/shell_storage.cpp` | `CmdInstall`, `CmdLastdump`, `CmdLsblk`, `CmdLsgpt`, `CmdLsmod`, `CmdMkfs`, `CmdMkfsDuetfs`, `CmdMount` |
