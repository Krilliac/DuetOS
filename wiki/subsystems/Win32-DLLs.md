...
| `customdll` | 3 | `userland/libs/customdll/` |
| `d2d1` | 1 | `userland/libs/d2d1/` |
| `d3d11` | 4 | `userland/libs/d3d11/` |
| `d3d12` | 5 | `userland/libs/d3d12/` |
| `d3d9` | 3 | `userland/libs/d3d9/` |
| `d3dcompiler` | 0 | `userland/libs/d3dcompiler/` |
| `dbghelp` | 36 | `userland/libs/dbghelp/` |
| `ddraw` | 4 | `userland/libs/ddraw/` |
| `dinput8` | 1 | `userland/libs/dinput8/` |
| `dsound` | 5 | `userland/libs/dsound/` |
| `dwmapi` | 25 | `userland/libs/dwmapi/` |
...
| `kernel32` | 394 | `userland/libs/kernel32/` |
...
| `oleaut32` | 10 | `userland/libs/oleaut32/` |
| `psapi` | 45 | `userland/libs/psapi/` |
| `secur32` | 32 | `userland/libs/secur32/` |
| `setupapi` | 45 | `userland/libs/setupapi/` |
| `shell32_32` | 2 | `userland/libs/shell32_32/` |
...
| `user32_32` | 64 | `userland/libs/user32_32/` |
...
| `wininet` | 55 | `userland/libs/wininet/` |
| `winmm` | 19 | `userland/libs/winmm/` |
| `ws2_32_32` | 41 | `userland/libs/ws2_32_32/` |
| `ws2_32` | 53 | `userland/libs/ws2_32/` |
| `wtsapi32` | 20 | `userland/libs/wtsapi32/` |
| `xaudio2_8` | 3 | `userland/libs/xaudio2_8/` |
| `xinput1_4` | 6 | `userland/libs/xinput1_4/` |
<!-- /AUTO:dll_list -->
